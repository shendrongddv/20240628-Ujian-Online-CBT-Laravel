...
@section('content')
    ...
    <div class="mt-5 flex flex-col gap-10 px-5">
        <div class="breadcrumb flex items-center gap-[30px]">
            ...
            <a href="#" class="text-[#7F8190] last:font-semibold last:text-[#0A090B]">Manage Courses</a>
            <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
            <a href="#" class="text-[#7F8190] last:font-semibold last:text-[#0A090B]">Course
                Students</a>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('dashboard.course.course_student.store', $course) }}" id="add-question"
        ...
        <button type="submit"
            class="h-[52px] w-[500px] rounded-full bg-[#6436F1] p-[14px_20px] text-center font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D]">Add
            Student</button>
    </form>
